...
//		看连接 http://www.cnblogs.com/flyme/p/4517560.html
...
//		得到类NavigationDrawerFragment的对象mNavigationDrawerFragment
		mNavigationDrawerFragment = (NavigationDrawerFragment) getSupportFragmentManager()
				.findFragmentById(R.id.navigation_drawer);
		mTitle = getTitle();//动态设置标题的值，getTitle()的值是该activity的声明中android:label的值
